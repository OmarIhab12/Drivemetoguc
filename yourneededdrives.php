...
if (isset($_POST['email'])){
    ...
    $result = mysqli_query($con,"select * from needdrive where email = '$email'");
    if ($result->num_rows > 0 ) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $neededdrives["reservationtimef"] = $row["reservationtimef"];
            $neededdrives["reservationtimel"] = $row["reservationtimel"];
